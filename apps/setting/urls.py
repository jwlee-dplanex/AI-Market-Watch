...
urlpatterns = [
    ...
    path("run/<str:job>/stop/", views.setting_run_stop, name="setting_run_stop"),
    ...
    path(
        "run/review/tag-candidates/<int:pk>/register/",
        views.setting_run_tag_candidate_register,
        name="setting_run_tag_candidate_register",
    ),
